...
export class UserSignUpService {
    ...
    getUserDetailsByMobile(mobileNo: string): Observable<any> {
        ...
        const apiUrl = `https://dictionaryappbackend-production.up.railway.app/api/user/userDetails/${mobileNo}`;
        return this.http.get(apiUrl);
    }
    ...
    getUserCount(): Observable<any> {
        ...
        const apiUrl = `https://dictionaryappbackend-production.up.railway.app/api/user/totalUserCount`;
        return this.http.get(apiUrl);
    }
}